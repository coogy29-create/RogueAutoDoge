...
local function rebuildBarrierParts()
	...
	for part in pairs(BarrierSet) do
		if part and part.Parent then
			...
			local minX = spatialCell(cf.Position.X - worldHX, BARRIER_GRID_CELL)
			local maxX = spatialCell(cf.Position.X + worldHX, BARRIER_GRID_CELL)
			local minZ = spatialCell(cf.Position.Z - worldHZ, BARRIER_GRID_CELL)
			local maxZ = spatialCell(cf.Position.Z + worldHZ, BARRIER_GRID_CELL)
...
Footer.Text = "Spatial MPC / Closed-form Curves / Native Focus"
